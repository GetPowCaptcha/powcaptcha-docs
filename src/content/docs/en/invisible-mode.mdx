...
description: How to integrate the widget in invisible mode
i18nReady: true
---
...
```
You can customize the invisible widget by adding various attributes to the `<powcaptcha-widget>` element. You can check the [widget attributes page](/en/widget-attributes/) for a complete list of available attributes.
